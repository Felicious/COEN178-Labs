...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    # collect input data
     ...
     if (!empty($empName)){
		...
		echo "Salary: of $empName is $salary, Title is $title <br>";
	 }
}
function getTitleFromDB($title){
	...
	oci_bind_by_name($query,':bv',$title); //bv replaces name to execute
	// Execute the query
	oci_execute($query);
